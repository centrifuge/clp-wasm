/* $Id: CoinBuild.hpp 2083 2019-01-06 19:38:09Z unxusr $ */
...
public:
   ...
   */
  int row(int whichRow, FloatT &rowLower, FloatT &rowUpper,
   ...
   */
  int currentRow(FloatT &rowLower, FloatT &rowUpper,
    const int *&indices, const FloatT *&elements) const;
  /// Set current row
   ...
   */
  int currentColumn(FloatT &columnLower, FloatT &columnUpper, FloatT &objectiveValue,
    const int *&indices, const FloatT *&elements) const;
  /// Set current column
...
private:
   ...
   */
  int currentItem(FloatT &itemLower, FloatT &itemUpper, FloatT &objectiveValue,
    const int *&indices, const FloatT *&elements) const;
  /// Set current item
